# TFRecord generation script for train/test data, adapted from datitran's GitHub: https://github.com/datitran/raccoon_dataset/blob/master/generate_tfrecord.py
"""
Usage:
